...
namespace ADS\UCCIA\EventSubscriber;
...
final class RedirectToPreferredLocaleSubscriber implements EventSubscriberInterface
{
    public function __construct(
        ...
        // Ajoutez les paramètres régionaux par défaut en première position du tableau.
        // Parce que Symfony\HttpFoundation\Request::getPreferredLanguage
        // renvoie le premier élément lorsque aucune langue appropriée n'est trouvée
    ...
    public function onKernelRequest(RequestEvent $event): void
    {
        ...
        // Ignorer les sous-requêtes et toutes les URL sauf la page d'accueil
        if (!$event->isMainRequest() || '/' !== $request->getPathInfo()) {
            return;
        }

        // Ignorer les requêtes provenant de référents ayant le même hôte HTTP afin d'éviter
        // Modification de la langue pour les utilisateurs qui l'ont peut-être déjà sélectionnée pour cette application.
